    ...
    public class Pacman
    {
        ...
        public void MovePacman(int direction)
        {
            ...
            if (CanMove)
            {
                ...
                UpdatePacmanImage();
                CheckPacmanPosition();
                Algoritmos.Pacman.ghost.CheckForPacman();
            }
        }
        ...
        private void CheckPacmanPosition()
        {
            ...
            switch (Algoritmos.Pacman.gameboard.Matrix[yCoordinate, xCoordinate])
            {
                case 1: Algoritmos.Pacman.food.EatFood(yCoordinate, xCoordinate); break;
                case 2: Algoritmos.Pacman.food.EatSuperFood(yCoordinate, xCoordinate); break;
            }
        }
        ...
        private bool direction_ok(int x, int y)
        {
            ...
            if (Algoritmos.Pacman.gameboard.Matrix[y, x] < 4) { return true; } else { return false; }
        }
